<?php
$headings = [
    'active' => ['Γνήσιο έγγραφο', 'Είναι καταχωρημένο στο μητρώο και η δηλωμένη ισχύς του είναι ενεργή.'],
    'expired' => ['Έληξε η ισχύς', 'Το έγγραφο είναι καταχωρημένο, όμως η ημερομηνία ισχύος του έχει παρέλθει.'],
...
<article class="certificate state-<?= e($state) ?>">
    <div class="wax wax-<?= e($state) ?>" aria-hidden="true">
        <span><?= $state === 'active' ? 'ΓΝΗΣΙΟ' : ($state === 'cancelled' ? 'ΑΚΥΡΟ' : ($state === 'expired' ? 'ΕΛΗΞΕ' : '—')) ?></span>
    </div>
