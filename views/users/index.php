<?php page_head('Διαχείριση', 'Χρήστες', 'Ο διαχειριστής ορίζει ονοματεπώνυμο, τμήμα, email, κωδικό και ρόλο. Η Γραμματεία βλέπει και επεξεργάζεται όλα τα έγγραφα. Οι ανενεργοί λογαριασμοί δεν συνδέονται.'); ?>
