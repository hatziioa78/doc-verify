<?php page_head('Διαχείριση', 'Χρήστες', 'Ο διαχειριστής ορίζει επώνυμο, όνομα, τμήμα, email, κωδικό και ρόλο. Η Γραμματεία βλέπει και επεξεργάζεται όλα τα έγγραφα. Οι ανενεργοί λογαριασμοί δεν συνδέονται.'); ?>
            ...
            <tbody>
                <?php foreach ($users as $person): ?>
                    <tr>
                        ...
                        <td>
                            <?= e(role_label((string) $person['role'])) ?>
