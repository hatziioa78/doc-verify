...
if ($isEdit) {
    page_head('Επεξεργασία', 'Στοιχεία εγγράφου', 'Η αλλαγή ενημερώνει το μητρώο. Αν το έγγραφο έχει ήδη σφραγιστεί, ανανεώνεται και η σελίδα επαλήθευσης του PDF.');
    ...
    page_head('Νέα καταχώρηση', 'Σφράγισμα PDF', 'Το αρχείο μένει ως έχει και στο τέλος του προστίθεται σελίδα με τον κωδικό QR. Η ημερομηνία καταχώρησης ορίζεται από το σύστημα.');
}
?>
